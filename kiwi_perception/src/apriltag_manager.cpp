...
#include "kiwi_interfaces/msg/april_tag_detection_stamped.hpp"
#include "kiwi_interfaces/action/query_april_tag_log.hpp"
...
{
  public:
    using QueryAprilTagLog = kiwi_interfaces::action::QueryAprilTagLog;
  ...
  private:
    ...
    void execute(const std::shared_ptr<GoalHandleQueryAprilTagLog> goal_handle)
    {
      ...
      for (int id : goal->tag_ids)
      {
        ...
        {
          kiwi_interfaces::msg::AprilTagDetectionStamped latest_detection;
...
RCLCPP_COMPONENTS_REGISTER_NODE(kiwi_perception::AprilTagManager)
